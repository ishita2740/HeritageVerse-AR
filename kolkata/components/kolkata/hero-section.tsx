    ...
    <>
      ...
      <section className="relative w-full h-screen bg-black overflow-hidden pt-12">
        ...
        <div className="absolute inset-0">
          ...
          >
            <source
              src="https://videos.pexels.com/video-files/3571091/3571091-hd_1920_1080_30fps.mp4"
              type="video/mp4"
            />
          </video>
        ...
        >
          ...
          <motion.div
            ...
            className="mb-6"
          >
            <div className="w-20 h-20 bg-[#d4a574] rounded-full flex items-center justify-center shadow-lg"
              style={{
                boxShadow: '0 0 40px rgba(212, 165, 116, 0.6)',
              }}
            >
              <span className="text-2xl font-bold text-[#2d5016]">HV</span>
            </div>
          </motion.div>
